      ...
      <nav className="navbar">
        ...
        <div className="nav-container">
          <ul className="nav-links">
            ...
            <li><NavLink to="/performing-arts" className={({ isActive }) => isActive ? 'active' : undefined}>Artists</NavLink></li>
            <li><NavLink to="/events" className={({ isActive }) => isActive ? 'active' : undefined}>Events</NavLink></li>
            <li><NavLink to="/blog" className={({ isActive }) => isActive ? 'active' : undefined}>Blog</NavLink></li>
          </ul>
          <NavLink to="/" className="btn-connect">Join Community</NavLink>
        </div>
      </nav>
          ...
          <div className="footer-content">
            <div className="footer-column footer-brand-column">
              ...
              <div className="footer-brand">
                ...
                <p className="copyright">Copyright © Usanii Deluxe {new Date().getFullYear()}</p>
              </div>
            </div>
            ...
            <div className="footer-column">
              ...
              <ul>
                ...
                <li><a href="mailto:partners@usaniideluxe.com">Partners</a></li>
                <li><a href="mailto:support@usaniideluxe.com">Support</a></li>
              </ul>
            </div>
            <div className="footer-column">
              <h4>Company</h4>
              <ul>
                ...
                <li><a href="mailto:talent@usaniideluxe.com">Careers</a></li>
                <li><a href="mailto:press@usaniideluxe.com">Press</a></li>
              </ul>
            </div>
            <div className="footer-column">
              <h4>Legal</h4>
              <ul>
                <li><a href="mailto:legal@usaniideluxe.com?subject=Terms">Terms</a></li>
                <li><a href="mailto:legal@usaniideluxe.com?subject=Privacy">Privacy</a></li>
              </ul>
            </div>
          </div>
        </div>
